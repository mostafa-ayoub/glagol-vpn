// ============================================================
// screens/home_screen_stable.dart
// ============================================================
...
class HomeScreenStable extends ConsumerStatefulWidget {
  const HomeScreenStable({super.key});

  @override
  ConsumerState<HomeScreenStable> createState() => _HomeScreenStableState();
}

class _HomeScreenStableState extends ConsumerState<HomeScreenStable> {
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ConnectButton(
                      status: status,
                      onTap: () => _handleConnectSafely(status, selectedServer),
                    ),
  ...
  Future<void> _handleConnectSafely(VpnStatus status, VpnServer? server) async {
    if (_isDisposed || server == null) return;
